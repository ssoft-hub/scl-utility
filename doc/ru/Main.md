...
SCL.Utility — header-only модуль инструментария ScL, предоставляющий помощники для метапрограммирования на этапе компиляции, утилиты препроцессора и расширенные свойства типов (type traits).
