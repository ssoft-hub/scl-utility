...
- Заголовок: `#include "scl/preprocessor.hpp"`
- Объявление: `#define SCL_EXPAND(...) __VA_ARGS__`
...
- SCL_EXPAND не добавляет скобок и не меняет группировку токенов. Если нужна
