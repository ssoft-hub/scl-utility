...
One constructor accepts any type at all. An owning [`scl::any`](any.md) and an
[`any_anchor`](any_anchor.md) have constructors of their own, each binding what that type
refers to rather than the object itself; the other handles of the group are refused, and an
[`any_mutable_view`](any_mutable_view.md) reaches a view through the conversion it offers.
