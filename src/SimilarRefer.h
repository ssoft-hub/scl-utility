...
namespace ScL::Detail
{
    ...
    struct SimilarReferHelper
    {
        ...
        using CVCheckedType = ::std::conditional_t<is_const,
            ::std::add_const_t<VCheckedType>,
            VCheckedType>;
        using LCVCheckedType = ::std::conditional_t<is_lvalue,
            ::std::add_lvalue_reference_t<CVCheckedType>,
            CVCheckedType>;
        using Type = ::std::conditional_t<is_rvalue,
            ::std::add_rvalue_reference_t<LCVCheckedType>,
            LCVCheckedType>;
        ...
        //     || ::ScL::Feature::is_similar< Type, _Refer >::value, "Result Type must to be similar
        //     _Refer" );
    };
} // namespace ScL::Detail
