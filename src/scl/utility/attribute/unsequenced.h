...
#if defined(__has_cpp_attribute) && __has_cpp_attribute(unsequenced)
#define SCL_UNSEQUENCED(...) __VA_ARGS__ [[unsequenced]]
#elif defined(_MSC_VER) && !defined(__clang__)
#define SCL_UNSEQUENCED(...) __VA_ARGS__
#elif defined(__has_cpp_attribute) && __has_cpp_attribute(gnu::const)
...
#if defined(__has_cpp_attribute) && __has_cpp_attribute(reproducible)
#define SCL_REPRODUCIBLE(...) __VA_ARGS__ [[reproducible]]
#elif defined(_MSC_VER) && !defined(__clang__)
#define SCL_REPRODUCIBLE(...) __VA_ARGS__
#elif defined(__has_cpp_attribute) && __has_cpp_attribute(gnu::pure)
