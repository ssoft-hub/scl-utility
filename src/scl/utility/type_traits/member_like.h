...
namespace scl::detail
{
    ...
    enum member_function_noexcept : bool
    {
        disabled = false,
        enabled = true
    };
    ...
    private:
        ...
        using un = Result (T::*)(Arguments...);
        using c = Result (T::*)(Arguments...) const;
        using v = Result (T::*)(Arguments...) volatile;
        using cv = Result (T::*)(Arguments...) const volatile;

        using un_l = Result (T::*)(Arguments...) &;
        using un_r = Result (T::*)(Arguments...) &&;
        using c_l = Result (T::*)(Arguments...) const &;
        using c_r = Result (T::*)(Arguments...) const &&;
        using v_l = Result (T::*)(Arguments...) volatile &;
        using v_r = Result (T::*)(Arguments...) volatile &&;
        using cv_l = Result (T::*)(Arguments...) const volatile &;
        using cv_r = Result (T::*)(Arguments...) const volatile &&;
    ...
    private:
        ...
        // All cv/ref forms in one place; noexcept is controlled by Noexcept
        using un = Result (T::*)(Arguments...) noexcept;
        using c = Result (T::*)(Arguments...) const noexcept;
        using v = Result (T::*)(Arguments...) volatile noexcept;
        using cv = Result (T::*)(Arguments...) const volatile noexcept;

        using un_l = Result (T::*)(Arguments...) & noexcept;
        using un_r = Result (T::*)(Arguments...) && noexcept;
        using c_l = Result (T::*)(Arguments...) const & noexcept;
        using c_r = Result (T::*)(Arguments...) const && noexcept;
        using v_l = Result (T::*)(Arguments...) volatile & noexcept;
        using v_r = Result (T::*)(Arguments...) volatile && noexcept;
        using cv_l = Result (T::*)(Arguments...) const volatile & noexcept;
        using cv_r = Result (T::*)(Arguments...) const volatile && noexcept;
