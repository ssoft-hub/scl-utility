    ...
    {                                                                                                           \
        ...
        using name##_member_exact_operation = decltype((::std::declval<Type>().*                                \
            ::std::integral_constant<                                                                           \
                ::scl::member_function_like_t<Type, name##_member_operation<Type, Arguments...>(Arguments...)>, \
                &::std::remove_cvref_t<Type>::operator op>::value)(::std::declval<Arguments>()...));            \
        template <typename... Arguments>                                                                        \
...
#define SCL_DETAIL_POSTFIX_UNARY_OPERATOR_DETECTION(op, name)                                                 \
    ...
    {                                                                                                         \
        template <typename Type>                                                                              \
        using name##_member_operation = decltype(::std::declval<Type>().operator op(::std::declval<int>()));  \
        template <typename Type>                                                                              \
    ...
    {                                                                                                         \
        template <typename Type>                                                                              \
        using name##_member_exact_operation = decltype((::std::declval<Type>().*                              \
            ::std::integral_constant<::scl::member_function_like_t<Type, name##_member_operation<Type>(int)>, \
                &::std::remove_cvref_t<Type>::operator op>::value)(::std::declval<int>()));                   \
        template <typename Type>                                                                              \
        inline constexpr auto has_##name##_member_exact_v =                                                   \
